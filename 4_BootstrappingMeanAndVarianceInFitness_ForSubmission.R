...
######################################################################################################################################################################
###   Script Details:                                                                                                                                              ###
###   Bootstrapping procedure for mean and variance in fitness for Singh, A. A.F., Agrawal. 2020. Sex-Specific Variance in Fitness and the Efficacy of Selection   ###
...
bootstrapped.data$adjusted.variance = (2/bootstrapped.data$mean.wt)* (1 - (2/bootstrapped.data$mean.wt))*bootstrapped.data$mean.wt + (2/bootstrapped.data$mean.wt)^2 * (bootstrapped.data$var.wt)

# Write the bootstrapped data file out to disk
write.csv(bootstrapped.data, file="/FILE/PATH/TO/BootstrappedFitnessDataFinalSept2020.csv")
